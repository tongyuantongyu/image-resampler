...
VN_STATUS vnSampleImage(CONST CVImage& pSrcImage,
                        ...
                        UINT8* pRawOutput) {
	if (VN_PARAM_CHECK) {
		if (!VN_IS_IMAGE_VALID(pSrcImage) || !pRawOutput) { return vnPostError(VN_ERROR_INVALIDARG); }
	...
	case VN_IMAGE_KERNEL_1D_VERTICAL: {
		...
		case VN_IMAGE_KERNEL_AVERAGE: return vnAverageKernel(pSrcImage, fX, fY, bDirection, fRadius,
		                                                     pRawOutput);
		case VN_IMAGE_KERNEL_BILINEAR: return vnBilinearKernel(pSrcImage, fX, fY, bDirection,
		                                                       pRawOutput);
		case VN_IMAGE_KERNEL_GAUSSIAN: return vnGaussianKernel(pSrcImage, fX, fY, bDirection, fRadius,
		                                                       pRawOutput);
		case VN_IMAGE_KERNEL_BICUBIC: return vnBicubicKernel(pSrcImage, 0, 1, fX, fY, bDirection,
		                                                     pRawOutput);
		case VN_IMAGE_KERNEL_CATMULL: return vnBicubicKernel(pSrcImage, 0, 0.5f, fX, fY, bDirection,
		                                                     pRawOutput);
		case VN_IMAGE_KERNEL_MITCHELL: return vnBicubicKernel(pSrcImage, 1.0f / 3.0f, 1.0f / 3.0f, fX,
		                                                      fY, bDirection, pRawOutput);
		case VN_IMAGE_KERNEL_CARDINAL: return vnBicubicKernel(pSrcImage, 0, 0.75f, fX, fY, bDirection,
		                                                      pRawOutput);
		case VN_IMAGE_KERNEL_BSPLINE: return vnBicubicKernel(pSrcImage, 1, 0, fX, fY, bDirection,
		                                                     pRawOutput);
		case VN_IMAGE_KERNEL_SPLINE: return vnSplineKernel(pSrcImage, fX, fY, bDirection, pRawOutput);
		case VN_IMAGE_KERNEL_LANCZOS: return vnLanczosKernel(pSrcImage, 1, fX, fY, bDirection,
		                                                     pRawOutput);
		case VN_IMAGE_KERNEL_LANCZOS2: return vnLanczosKernel(pSrcImage, 2, fX, fY, bDirection,
		                                                      pRawOutput);
		case VN_IMAGE_KERNEL_LANCZOS3: return vnLanczosKernel(pSrcImage, 3, fX, fY, bDirection,
		                                                      pRawOutput);
		case VN_IMAGE_KERNEL_LANCZOS4: return vnLanczosKernel(pSrcImage, 4, fX, fY, bDirection,
		                                                      pRawOutput);
		case VN_IMAGE_KERNEL_LANCZOS5: return vnLanczosKernel(pSrcImage, 5, fX, fY, bDirection,
		                                                      pRawOutput);
		case VN_IMAGE_KERNEL_COVERAGE: return vnCoverageKernel(pSrcImage, fX, fY, bDirection, fRadius,
		                                                       pRawOutput);
		}
	}
		break;
